...
assert_contains "${UI_ONLY}" "prep_targets: pwa"
assert_contains "${UI_ONLY}" "command: npm --prefix ${ROOT_DIR}/repos/igloo-ui test"
assert_not_contains "${UI_ONLY}" "command: npm --prefix ${ROOT_DIR}/repos/igloo-ui run build"
assert_contains "${UI_ONLY}" "command: FROSTR_TEST_PREPARED=1 npm --prefix ${ROOT_DIR}/test run test:e2e:igloo-pwa"
assert_not_contains "${UI_ONLY}" "test:e2e:igloo-home"
assert_not_contains "${UI_ONLY}" "test:e2e:igloo-chrome"

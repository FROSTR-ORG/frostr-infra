...
IGLOO_SHELL_DEMO_DIR="${IGLOO_SHELL_DEMO_DIR:-${ROOT_DIR}/data/test-harness/demo-2of3}"
IGLOO_SHELL_DEMO_CONTROL_SOCKET="${IGLOO_SHELL_DEMO_CONTROL_SOCKET:-${ROOT_DIR}/data/test-harness/igloo-shell-${IGLOO_SHELL_DEMO_MEMBER}.sock}"
IGLOO_SHELL_DEMO_CONTROL_TOKEN_FILE="${IGLOO_SHELL_DEMO_CONTROL_TOKEN_FILE:-${ROOT_DIR}/data/test-harness/igloo-shell-${IGLOO_SHELL_DEMO_MEMBER}.token}"
IGLOO_SHELL_DEMO_ARTIFACT_DIR="${IGLOO_SHELL_DEMO_ARTIFACT_DIR:-${ROOT_DIR}/data/test-harness}"

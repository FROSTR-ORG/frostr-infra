...
| --- | --- | --- | --- |
| [ADR-001](./ADR-001-thin-host-signer-authority.md) | Accepted | Thin host, signer authority | [ARCHITECTURE.md](../ARCHITECTURE.md) |
| [ADR-002](./ADR-002-encrypted-onboarding-hard-cut.md) | Accepted | Encrypted onboarding hard cut | [PROTOCOL.md](../PROTOCOL.md) |
| [ADR-003](./ADR-003-runtime-status-and-events.md) | Accepted | Runtime status and events | [PROTOCOL.md](../PROTOCOL.md), [ARCHITECTURE.md](../ARCHITECTURE.md) |
| [ADR-004](./ADR-004-cross-repo-e2e-ownership.md) | Accepted | Cross-repo E2E ownership | top-level `test/` and infra test docs |
